...
class NaiveProbabilistic:
    ...
    def NaiveProbabilistic(self, user, env, thres):
        ...
        for i in range(1, threshold):
            self.freq[env.mem_states[i]][env.mem_action[i]] += env.mem_reward[i]+0.00000000000000000000000000000000001
...
if __name__ == "__main__":
    ...
    for u in user_list_2D:
        ...
        for thres in threshold:
            ...
            dataframe_algorithm.append("Greedy")
