...
if __name__ == "__main__":
    ...
    p1 = multiprocessing.Process(target=obj2.hyper_param, args=(env, user_list_2D[:1], 'qlearning', 1,))
    ...
    p2 = multiprocessing.Process(target=obj2.hyper_param, args=(env, user_list_3D[:1], 'qlearning', 1,))
