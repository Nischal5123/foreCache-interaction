...
class OnlineSVM:
    ...
    def __init__(self, actions):
        ...
        """
        self.model = SGDClassifier(loss='hinge', alpha=1e-3, max_iter=5, tol=None)  # SVM with hinge loss
...
def get_overall_accuracy():
    ...
    for dataset in datasets:
        task_accuracy = []
        for task in tasks:
            data = pd.read_csv("Experiments_Folder/VizRec/{}/{}/OfflineSVM.csv".format(dataset, task))
        ...
        for task in tasks:
            ...
            for u in user_list_2D:
                ...
                for thres in threshold:
                    ...
                    accu = obj.online_svm_driver(u, env, thres)
