...
import numpy as np
from environment_vizrec import environment_vizrec
...
class ReplayBuffer():
    ...
    def sample(self, n):
        ...
        s_batch, a_batch, r_batch, s_prime_batch, done_batch = torch.tensor(np.array(s_lst),
...
def train():
    ...
    for n_epi in range(10000):
        ...
        if memory.size() > 2000:
            q.train_net(q, q_target, memory, optimizer)
