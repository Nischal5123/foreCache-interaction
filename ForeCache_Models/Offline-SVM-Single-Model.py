...
def run_experiment(user_list, dataset, task):
    ...
    # Save results to CSV
    result_dataframe.to_csv(f"Experiments_Folder/VizRec/{dataset}/{task}/OfflineSVM-PartialTrain-Single-Model.csv", index=False)
...
def get_average_accuracy():
    ...
    for dataset in datasets:
        for task in tasks:
            result_df = pd.read_csv(f"Experiments_Folder/VizRec/{dataset}/{task}/OfflineSVM-PartialTrain-Single-Model.csv")
