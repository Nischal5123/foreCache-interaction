...
def get_test_train_split(filename, thres):
        ...
        return mem_states[:threshold], mem_action[:threshold], mem_reward[:threshold], mem_states[
                                                                                       threshold:], mem_action[
                                                                                                    threshold:], mem_reward[
                                                                                                                 threshold:]
...
def run_experiment(user_list, dataset, task):
    ...
    output_file = f"{directory}/Offline-SVM-Thresholded-Single-Model.csv"
