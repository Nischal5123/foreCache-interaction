...
def training(train_files, env, algorithm, epoch):
    hyperparam_file = '/Users/aryal/Desktop/ForeCache/foreCache-interaction/ForeCache_Models/sampled-hyperparameters-config.json'
...
def testing(test_files, env, trained_Q, alpha, eps, discount, algorithm):
    ...
    for user in [test_files]:
        ...
        env.process_data(user, 0.80)
        model = Qlearning()
        Q, accu_user = model.q_learning(Q, env, 50, discount, alpha, eps)
...
if __name__ == "__main__":
    ...
    for d in datasets:
        for task in tasks:
            ...
            directory = f"/Users/aryal/Desktop/ForeCache/foreCache-interaction/ForeCache_Models/Experiments_Folder/VizRec/{d}/{task}/PopulationThreshold"
            os.makedirs(directory, exist_ok=True)
            output_file = f"{directory}/QLearn-Thresholded-Single-Model.csv"
