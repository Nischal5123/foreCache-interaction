...
```
```{r}
combined_model_reporting_same <-lmer(formula = probabsame~ Trial + (1|Openend) + (1 | u) + (1 | Dataset), data = data_both_pall)
...
```
```{r}
combined_model_reporting_modify2 <-lmer(formula = probabmodify2~ Trial + (1|Openend) + (1 | u) + (1 | Dataset), data = data_both_pall)
...
```
```{r}
combined_model_reporting_modify3 <-lmer(formula = probabmodify3~ Trial + (1 | u) + (1 | Dataset), data = data_both_pall)
