...
combined_model_full_same <- lmer(formula = probabsame~ Trial + (1 | u) + (1 | Dataset)  + (1 | Openend) , data = data_both_pall, REML = FALSE)
reducedmodel_same <- lmer(formula =  probabsame ~ 1 + (1 | u) + (1 | Openend) +(1 | Dataset), data = data_both_pall, REML = FALSE)
lrtest(reducedmodel_same, combined_model_full_same)
```
```{r}
combined_model_reporting_same <-lmer(formula = probabsame~ Trial + (1 | u) + (1 | Dataset)  + (1 | Openend), data = data_both_pall)
...
```
```{r}
combined_model_full_modify1 <- lmer(formula = probabmodify1~ Trial  + (1|Openend) + (1|Dataset) + (1|u), data = data_both_pall, REML = FALSE)
reducedmodel_modify1 <- lmer(formula =  probabmodify1 ~ 1  + (1|Openend) + (1|Dataset) + (1|u), data = data_both_pall, REML = FALSE)
lrtest(reducedmodel_modify1, combined_model_full_modify1)
```
```{r}
combined_model_reporting_modify1 <-lmer(formula = probabmodify1~ Trial  + (1|Openend) + (1|Dataset) + (1|u), data = data_both_pall)
...
```
```{r}
combined_model_full_modify2 <- lmer(formula = probabmodify2~ Trial + (1 | u)  +(1 | Trial) + (1|Openend), data = data_both_pall, REML = FALSE)
reducedmodel_modify2 <- lmer(formula =  probabmodify2 ~ 1 + (1 | u) + (1 | Trial) + (1|Openend), data = data_both_pall, REML = FALSE)
lrtest(reducedmodel_modify2, combined_model_full_modify2)
```
```{r}
combined_model_reporting_modify2 <-lmer(formula = probabmodify2~ Trial +  (1|Openend) + (1|Dataset) + (1|u), data = data_both_pall)
...
```{r}
combined_model_full_modify3 <- lmer(formula = probabmodify3~ Trial + (1|Openend) + (1|Dataset)  + (1|u), data = data_both_pall, REML = FALSE)
reducedmodel_modify3 <- lmer(formula =  probabmodify3 ~ 1 +  (1|Openend) + (1|Dataset) + (1|u), data = data_both_pall, REML = FALSE)
lrtest(reducedmodel_modify3, combined_model_full_modify3)
```
```{r}
combined_model_reporting_modify3 <-lmer(formula = probabmodify3~ Trial + (1|Openend) + (1|Dataset)  + (1|u), data = data_both_pall)
