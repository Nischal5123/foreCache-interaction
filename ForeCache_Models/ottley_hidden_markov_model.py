...
if __name__ == '__main__':
    ...
    continuous_attributes = {
        'movies': [['attribute1', 'attribute2', 'attribute3']]
    }
    ...
    output_file_path = './output/movies/movies_results_hmm.pkl'
            ...
            for i in tqdm(range(threshold+1 , len(interaction_data.iloc[participant_index].interaction_session))):
                ...
                if i < len(interaction_data.iloc[participant_index].interaction_session) - 1:
                    ...
                    for k in ks:
                        ...
                        action_predicted = get_action_from_next_point(original_data,predicted_next_point)
                        #get the actual action from the actual next_point
                        action_true= get_action_from_next_point(original_data,[next_point])
